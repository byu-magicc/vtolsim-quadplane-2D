...
viewer = ViewManager(animation=True, world_map=worldMap)
...
waypoints_smooth = flight_corridors_smooth_path(
    waypoints_not_smooth=waypointsNotSmooth, world_map=worldMap, angle_max=np.pi / 2
)

viewer.drawWaypoints(waypoints=waypoints_smooth, n_hat=n_hat, p0=mapOrigin_3D)
