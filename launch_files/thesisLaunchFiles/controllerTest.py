...
quadplane_startPos_3D = np.array([[0.0],[0.0],[0.0]])
quadplane_startVel_3D = np.array([[0.0],[0.0],[-0.5]])
theta_0_deg = 20.0
...
quadplane = QuadplaneDynamics(
    ...
    pos_3D_inertial_init=quadplane_startPos_3D,
    vel_3D_inertial_init=quadplane_startVel_3D,
    theta0=np.radians(theta_0_deg)
)
...
pos_desired = np.array([[0.0],[0.0]])
vel_desired = np.array([[0.0],[-0.5]])
accel_desired = np.array([[0.0],[-0.25]])
