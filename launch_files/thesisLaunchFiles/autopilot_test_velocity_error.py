...
#creates the offset vector to seperate the starting position down a piece 
#to see how it handles a step error
offsetVector_2D = np.array([[0.0],[25.0]])
offsetVector_3D = map_2D_to_3D(vec_2D=offsetVector_2D, plane=CONDA.plane_msg)
...
#this is start position of the TRAJECTORY! and not the actual aircraft. The aircraft starts with a different error.
...
quadplane = QuadplaneDynamics(
    ...
    pos_3D_inertial_init=(startPosition_3D + offsetVector_3D),
